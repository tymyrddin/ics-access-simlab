...
hosts that legitimately need it (uupl-historian, engineering workstation).
...
3. Cross-reference meter readings with uupl-historian data to detect injected false
   readings (uupl-historian ingest is unauthenticated; see the uupl-historian README).
