...
The `distribution-scada` component is an earlier custom Python SCADA implementation.
...
This directory is preserved and the Dockerfile is functional, but `distribution-scada`
