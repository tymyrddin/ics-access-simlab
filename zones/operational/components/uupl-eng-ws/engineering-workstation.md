...
* uupl-historian URL and `Historian2015` credential
* SCADA web URL and `admin/admin`
* SCADA SSH: `scada_admin / W1nd0ws@2016`
* uupl-historian SSH: `hist_admin / Historian2015`
* relay IED web interfaces: `admin/relay1234` for both
* HMI SSH and web: `operator/operator`

The file's comment is: "DB credentials: uupl-historian / Historian2015  (never
changed, 'it's fine')".
...
* `Documents\engineering_notes.txt`
  ...
  Historian:
    ...
    DB credentials: uupl-historian / Historian2015  (never changed, "it's fine")
...
engineering_notes.txt → uupl-historian ingest: hist_read/history2017
