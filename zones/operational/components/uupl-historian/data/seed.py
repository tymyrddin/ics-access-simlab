"""Seed the historian readings table with plausible time-series for an ICS process.

Usage: python3 seed.py <ics_process> <db_path>
"""
...
def seed(ics_process: str, db_path: str) -> None:
    ...
    # DB and service credentials in the config table (CTF loot).
    conn.execute("""
    ...
    # SSH and ingest creds, discoverable via the /export path traversal
    ...
    # Alarm setpoints; values match the trip thresholds in relay_server.py and plc_server.py.
    conn.execute("""
