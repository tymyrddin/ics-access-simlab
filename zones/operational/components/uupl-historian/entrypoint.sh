...
echo "[uupl-historian] Data source: $DATA_SOURCE"
echo "[uupl-historian] DB path: $DB_PATH"

if [ ! -f "$DB_PATH" ]; then
    echo "[uupl-historian] Seeding database..."
...
<DataSources>
  <Source name="hex-turbine-plc" type="modbus-tcp">
    <IP>10.10.3.21</IP>
    <Port>502</Port>
...
C:\Historian\Data\
==================
The uupl-historian database lives here. Do not move or delete.
...
/usr/sbin/sshd
echo "[uupl-historian] Starting web interface on :8080"
