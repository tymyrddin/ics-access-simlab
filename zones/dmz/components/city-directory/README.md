...
(e.g. `uupl-historian.uupl.am`) redirects those clients to an attacker-controlled
address. If any DMZ component queries the uupl-historian by hostname and uses this
