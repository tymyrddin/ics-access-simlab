"""UU P&L substation RTU (Dolly Sisters / Nap Hill feeder).

  :2404  IEC 60870-5-104, no auth
  :8080  REST management API, no auth

A REST write to /datapoints/<id> also pushes the value over IEC-104.
"""
...
# IEC-104 type IDs: 13 = M_ME_NC_1 (short float), 1 = M_SP_NA_1 (single point)
TYPE_MAP = {
...
# DATAPOINTS backs the REST API; POINTS_BY_ID holds live c104 points so a REST
# write can also push over IEC-104. Both guarded by STATE_LOCK.
DATAPOINTS = {}
POINTS_BY_ID = {}
